		...
		<div class="gtco-container">
			<div class="row">
				<div class="col-sm-4 col-xs-12">
					<a href="/">
					<div id="gtco-logo"><img class="logs" src="{{asset('spica')}}/images/logomini.png"></div>
					</a>
				</div>
      ...
      <div class="row row-p b-md">
        ...
        <div class="col-md-3 col-md-push-1"  style="margin-top:50px;">
          <div class="gtco-widget">
            ...
            <ul class="gtco-footer-links">
              <li ><a style="color: white;" href="/travelagent">Travel Agent</a></li>
              <li><a href="/bookingplatform" style="color: white;">Booking Platform</a></li>
              <li><a href="/companydiscount" style="color: white;">Corporate Event</a></li>
              <li><a href="/influencer" style="color: white;">Influencer</a></li>
              <li><a href="/influencer" style="color: white;">Affiliate Program</a></li>
              <li><a href="/influencer" style="color: white;">Sell Your Tours</a></li>
            </ul>
          </div>
